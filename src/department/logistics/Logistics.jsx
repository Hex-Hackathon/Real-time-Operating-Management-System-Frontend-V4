...
import Truck from '../../pages/logistics/Truck';
import DeliveryHistory from '../../pages/logistics/DeliveryHistory';
  ...
  return (
    <Routes>
      ...
      <Route
        path="*"
        element={
          localStorage.getItem('logistics-token') ? (
            <LogisticsPanel />
          ) : (
            <Navigate to="/logistics/login" />
          )
        }
      />
    </Routes>
